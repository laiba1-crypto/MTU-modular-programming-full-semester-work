...
def review_bookings(acc_type, numbers, extras_numbers):
    ...
    print("Total No. Of Pool Passes : ", extras_numbers[1])
    print("No. Of Kids Club : ", extras_numbers[0])
    if numbers[0] > numbers[1] and numbers[0] > numbers[2]:
        print("Most Popular accomodation : ", acc_type[0])
    elif numbers[1] > numbers[0] and numbers[1] > numbers[2]:
        print("Most Popular accomodation : ", acc_type[1])
    elif numbers[2] > numbers[0] and numbers[2] > numbers[1]:
        print("Most Popular accomodation : ", acc_type[2])
